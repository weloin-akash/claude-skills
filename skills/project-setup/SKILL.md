...
7. **Progress is law.** Task done ⇒ progress file checkbox + STATE.md `next:` updated ⇒ same commit. No exceptions (sole carve-out: parallel dispatch's session-owned STATE.md, 06 §Dispatch), no batching updates "later".
